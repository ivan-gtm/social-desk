...
function install($Plugin)
{
    ...
    $sql  = "DROP TABLE IF EXISTS `".TABLE_PREFIX."welcomedm_schedule`;";
    ...
    $sql .= "DROP TABLE IF EXISTS `".TABLE_PREFIX."welcomedm_log`;";
...
function route_maps($global_variable_name)
{
    ...
    // Log
    $GLOBALS[$global_variable_name]->map("GET|POST", "/e/".IDNAME."/[i:id]/messages/?", [
        PLUGINS_PATH . "/". IDNAME ."/controllers/MessagesController.php",
        __NAMESPACE__ . "\MessagesController"
    ]);
