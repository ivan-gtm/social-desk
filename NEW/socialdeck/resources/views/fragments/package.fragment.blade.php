        <div class="skeleton skeleton--full" id="package">
            <div class="clearfix">
                <aside class="skeleton-aside hide-on-medium-and-down">
                    <?php 
                        $form_action = Config::get('constants.APPURL')."/packages";
                    ...
                    <div class="js-loadmore-content">
                        ...
                        <div class="loadmore pt-20 none">
                            <a class="fluid button button--light-outline js-loadmore-btn js-autoloadmore-btn" data-loadmore-id="1" href="<?= Config::get('constants.APPURL')."/packages?aid=".$Package->get("id") ?>">
                ...
                <section class="skeleton-content">
                    <form class="js-ajax-form"
                          action="<?= Config::get('constants.APPURL')."/packages/".($Package->isAvailable() ? $Package->get("id") : "new") ?>"
                          method="POST">
