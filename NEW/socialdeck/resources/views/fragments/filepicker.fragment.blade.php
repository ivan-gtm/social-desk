        <div class="filepicker">
            <div class="filepicker-inner">
                ...
                <div class="filepicker-wrp">
                    <div id="filemanager" 
                         data-connector-url="<?= Config::get('constants.APPURL')."/file-manager/connector?keep_original_file=true" ?>"
                         data-page-size="28"
                         data-multiselect="false"
                         data-img-assets-url="<?= Config::get('constants.APPURL')."/assets/img/" ?>"></div>
                </div>
