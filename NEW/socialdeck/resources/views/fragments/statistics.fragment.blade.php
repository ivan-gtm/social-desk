            ...
            <div class="container-1200">
                <div class="row clearfix">
                    <?php if ($Accounts->getTotalCount() > 0): ?>
                        <form action="<?= Config::get('constants.APPURL')."/statistics" ?>" method="GET">
                        ...
                        <div class="clearfix">
                            <div class="col s12 m6 l6 mt-30">
                                <section class="section">
                                    <div class="section-content account-summary onprogress" data-url="<?= Config::get('constants.APPURL')."/statistics?account=".$ActiveAccount->get("id") ?>">
