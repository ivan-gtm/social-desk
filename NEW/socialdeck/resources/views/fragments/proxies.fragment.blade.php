                ...
                <aside class="skeleton-aside">
                            ...
                            <?php foreach ($Proxies->getDataAs("Proxy") as $p): ?>
                                <div class="aside-list-item js-list-item <?= $active_item_id == $p->get("id") ? "active" : "" ?>">
                                    <div class="clearfix">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="javascript:void(0)" 
                                                           ...
                                                           data-id="<?= $p->get("id") ?>" 
                                                           data-url="<?= Config::get('constants.APPURL')."/proxies" ?>">
                                                            <?= __("Delete") ?>
                                                        </a>
                                                    </li>
                                                </ul>
                                        ...
                                        <a class="full-link js-ajaxload-content" href="<?= Config::get('constants.APPURL')."/proxies/".$p->get("id") ?>"></a>
                                    </div>
                                </div>
                            <?php endforeach ?>
                        </div>
                    ...
                    <?php else: ?>
                        <div class="no-data">
                            ...
                            <a class="small button" href="<?= Config::get('constants.APPURL')."/proxies/new" ?>">
