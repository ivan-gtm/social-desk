            ...
            <div class="clearfix">
                <aside class="skeleton-aside hide-on-medium-and-down">
                    ...
                    <div class="loadmore pt-20 none">
                        <a class="fluid button button--light-outline js-loadmore-btn js-autoloadmore-btn" 
                           data-loadmore-id="1" href="<?= Config::get('constants.APPURL')."/proxies?aid=".$Proxy->get("id") ?>">
                ...
                <section class="skeleton-content">
                    <form class="js-ajax-form"
                          action="<?= Config::get('constants.APPURL')."/proxies/".($Proxy->isAvailable() ? $Proxy->get("id") : "new") ?>"
                          method="POST">
