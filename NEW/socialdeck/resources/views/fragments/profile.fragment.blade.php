        <div class='skeleton' id="profile">
                    ...
                    <div class="row clearfix">
                        <div class="alert danger <?= \Input::get("a") ? "heartbeat" : "" ?>">
                            <div class="msg">
                                ...
                                <a href="javascript:void(0)" class="js-resend-verification-email" data-url="<?= Config::get('constants.APPURL')."/profile" ?>"><?= __("Resend email") ?></a>
                                <em class="js-resend-result"></em>
                            </div>

                            <img src="<?= Config::get('constants.APPURL')."/assets/img/round-loading.svg" ?>" alt="loading" class="progress">
                        </div>
                    </div>
                </div>
            <?php endif ?>
            ...
            <form class="js-ajax-form" 
                  action="<?= Config::get('constants.APPURL') . "/profile" ?>"
                  method="POST">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <?php if ($recurring_payments): ?>
                                                <a class="small button js-cancel-recurring-payments" href="javascript:void(0)" data-url="<?= Config::get('constants.APPURL')."/profile" ?>"><?= __("Cancel Automatic Payments") ?></a>
                                            <?php else: ?>
                                                <?php if ($Package->isAvailable()): ?>
                                                    <a class="small button" href="<?= Config::get('constants.APPURL')."/renew" ?>"><?= __("Renew Account") ?></a>
                                                <?php elseif ($AuthUser->get("package_id") == 0): ?>
                                                    <a class="small button" href="<?= Config::get('constants.APPURL')."/renew" ?>"><?= __("Upgrade Account") ?></a>
                                                <?php else: ?>
                                                    <a class="small button" href="<?= Config::get('constants.APPURL')."/renew" ?>"><?= __("Upgrade Account") ?></a>
                                                <?php endif; ?>
                                            <?php endif ?>
