            <form class="js-ajax-form" 
                  action="<?= Config::get('constants.APPURL') . "/settings/" . $page ?>"
                  method="POST">
                    ...
                    <div class="clearfix">
                        <div class="col s12 m6 l5">
                            ...
                            <div class="mb-40">
                                ...
                                <ul class="field-tips">
                                    <li>Allows to search for hashtags and users directly in caption and first comment inputs in the <a href='<?= Config::get('constants.APPURL')."/post" ?>'>post page</a></li>
