                ...
                <div class="subscriptions">
                    <div class="inner">
                        ...
                        <form class="payment-form" 
                              ...
                              data-url="<?= Config::get('constants.APPURL')."/renew?package=".$SelectedPackage->get("id") ?>"
                              data-stripe-key="<?= htmlchars($Integrations->get("data.stripe.publishable_key")) ?>"
                              data-stripe-img="<?= Config::get('constants.APPURL')."/assets/img/shield.png" ?>"
                                                ...
                                                <?php if ($Integrations->get("data.stripe.publishable_key") && $Integrations->get("data.stripe.secret_key")): ?>
                                                    <div class="option-group-item">
                                                        <label>
                                                            ...
                                                            <div>
                                                                <div class="text-c">
                                                                    <img src="<?= Config::get('constants.APPURL')."/assets/img/cc/visa.svg" ?>" alt="Visa">
                                                                    <img src="<?= Config::get('constants.APPURL')."/assets/img/cc/mastercard.svg" ?>" alt="MasterCard">
                                                                </div>
                                                            </div>
                                                        </label>
                                                    </div>
                                                ...
                                                <?php if ($Integrations->get("data.paypal.client_id") && $Integrations->get("data.paypal.client_secret")): ?>
                                                    <div class="option-group-item">
                                                        <label>
                                                            ...
                                                            <div>
                                                                <div class="text-c">
                                                                    <img src="<?= Config::get('constants.APPURL')."/assets/img/cc/paypal.svg" ?>" alt="Visa">
                                                                </div>
                                                            </div>
                                                        </label>
                                                    </div>
                            ...
                            <?php foreach ($Packages->getDataAs("Package") as $p): ?>
                                <div class="package-list-item">
                                    <div>
                                        ...
                                        <div class="choose">
                                            <a href="<?= Config::get('constants.APPURL')."/renew?package=".$p->get("id") ?>" class="button button--dark button--oval"><?= __("Select") ?></a>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
