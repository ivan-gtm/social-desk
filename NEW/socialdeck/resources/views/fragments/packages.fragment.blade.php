                            ...
                            <?php if ($Packages->getPage() == 1): ?>
                                <div class="aside-list-item <?= $active_item_id == "trial" ? "active" : "" ?>">
                                    <div class="clearfix">
                                        ...
                                        <a class="full-link js-ajaxload-content" href="<?= Config::get('constants.APPURL')."/packages/trial" ?>"></a>
                                    </div>
                                </div>
                            <?php endif ?>
                            ...
                            <?php foreach ($Packages->getDataAs("Package") as $p): ?>
                                <div class="aside-list-item js-list-item <?= $active_item_id == $p->get("id") ? "active" : "" ?>">
                                    <div class="clearfix">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="javascript:void(0)" 
                                                           ...
                                                           data-id="<?= $p->get("id") ?>" 
                                                           data-url="<?= Config::get('constants.APPURL')."/packages" ?>">
                                                            <?= __("Delete") ?>
                                                        </a>
                                                    </li>
                                                </ul>
                                        ...
                                        <a class="full-link js-ajaxload-content" href="<?= Config::get('constants.APPURL')."/packages/".$p->get("id") ?>"></a>
                                    </div>
                                </div>
                            <?php endforeach ?>
                        </div>
