        <div class="skeleton skeleton--full" id="user">
            <div class="clearfix">
                <aside class="skeleton-aside hide-on-medium-and-down">
                    <?php 
                        $form_action = Config::get('constants.APPURL')."/users";
                    ...
                    <div class="js-search-results">
                        ...
                        <div class="loadmore pt-20 none">
                            <a class="fluid button button--light-outline js-loadmore-btn js-autoloadmore-btn" data-loadmore-id="1" href="<?= Config::get('constants.APPURL')."/users?aid=".$User->get("id")."&q=".urlencode(Input::get("q")) ?>">
                ...
                <section class="skeleton-content">
                    <form class="js-ajax-form"
                          action="<?= Config::get('constants.APPURL')."/users/".($User->isAvailable() ? $User->get("id") : "new") ?>"
                          method="POST">
