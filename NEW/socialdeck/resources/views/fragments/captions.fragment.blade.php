                ...
                <div class="row clearfix">
                                ...
                                <div class="box-list-item js-list-item">
                                    ...
                                    <div class="options context-menu-wrapper">
                                        ...
                                        <div class="context-menu">
                                            <ul>
                                                <li>
                                                    <a href="<?= Config::get('constants.APPURL')."/captions/".$c->get("id") ?>">
                                                        <?= __("Edit") ?>
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" 
                                                       ...
                                                       data-id="<?= $c->get("id") ?>" 
                                                       data-url="<?= Config::get('constants.APPURL')."/captions" ?>">
                                                        <?= __("Delete") ?>
                                                    </a>
                                                </li>
                                            </ul>
                                    ...
                                    <div>
                                        <a class="fluid button button--footer" href="<?= Config::get('constants.APPURL')."/post?caption=".$c->get("id") ?>">
                                            <?= __("Use caption") ?>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <?php else: ?>
                        <div class="no-data">
                            ...
                            <a class="small button" href="<?= Config::get('constants.APPURL')."/captions/new" ?>">
