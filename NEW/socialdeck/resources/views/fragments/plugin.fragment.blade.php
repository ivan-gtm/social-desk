        <div class='skeleton' id="plugin">
            <?php if (empty($InstallResult)): ?>
                <form action="<?= Config::get('constants.APPURL') . "/plugins/install" ?>" method="POST">
                ...
                <div class="minipage">
                    <?php if ($InstallResult->resp == 1): ?>
                        <div class="inner">
                            ...
                            <a href="<?= Config::get('constants.APPURL')."/plugins" ?>" class="small button"><?= __("View Modules") ?></a>
                        </div>
                    <?php else: ?>
                        <div class="inner">
                            ...
                            <a href="<?= Config::get('constants.APPURL')."/plugins/install" ?>" class="small button"><?= __('Try Again') ?></a>
                        </div>
                    <?php endif ?>
                </div>
            <?php endif ?>
