        <div class='skeleton' id="account">
            <form class="js-ajax-form" 
                  action="<?= Config::get('constants.APPURL') . "/accounts/challenge/" . $Challenge->get("id") . "." . $Challenge->get("choice") . "." . md5($Challenge->get("id").NP_SALT) ?>"
                  method="POST">
                        ...
                        <?php else: ?>
                            <div class="minipage">
                                <div class="inner">
                                    ...
                                    <a href="<?= Config::get('constants.APPURL')."/accounts" ?>" class="small button"><?= __('Try Again') ?></a>
                                </div>
                            </div>
                        <?php endif ?>
                    </div>
