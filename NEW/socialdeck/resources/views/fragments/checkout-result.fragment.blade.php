        <div id="checkout-result" class="minipage">
            <?php if (empty($Success)): ?>
                <div class="inner">
                    ...
                    <a href="<?= Config::get('constants.APPURL')."/renew" ?>" class="small button"><?= __('Try Again') ?></a>
                    <a href="<?= Config::get('constants.APPURL') ?>" class="small button button--simple"><?= __('Go to Home') ?></a>
                </div>
            <?php else: ?>
                <div class="inner">
                    <span class="icon">
