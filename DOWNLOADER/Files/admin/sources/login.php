...
<div id="user_login_ftp">
	...
	<!-- errores -->
	<!-- user -->
	<div id="error_user_login" class="error_login_user"><p class="class_p_error">Error al intentar acceder con el usuario </p></div>
	<!-- host -->
	<div id="error_host_login" class="error_login_user"><p class="class_p_error">Error al tratar de conectar con </p></div>
	<!-- null -->
	<div id="error_can_login" class="error_login_user"><p class="class_p_error">Error: Rellena todos los campos </p></div>
</div>