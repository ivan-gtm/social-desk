<section id="wall_section">
	...
	<form method="post" action="content_data.php?data=ads" charset="UTF-8">
		<div class="wall_class_settings">
			<p class="text_p"><?php echo $lags21; ?></p>
			<textarea  class="class_settings_textarea" name="as_one" id="as_one" cols="60" rows="10"><?php echo $ad_one; ?></textarea><br><br>
			<p class="text_p"><?php echo $lags22; ?></p>
			<textarea  class="class_settings_textarea" name="as_two" id="as_two" cols="60" rows="10"><?php echo $ad_two; ?></textarea><br><br>
			<br> 
			<br> 
			<br> 
			<center>
