...
*/
	...
	//-- url video		
		echo'<a class="button_video_more" href="download.php?url_video='.base64_encode($meta['video']).'&title='.$meta['title'].'" download="downloadfilename"><b>'.getSize($meta['video']).'</b>'.$lang7.'<spam class="data_video_donw_spam">'.Format_video(base64_encode($meta['video'])).'</spam></a>';
		echo '		</div>';
		echo '		<br>';
		echo '	</div>';
		echo '</div>';  
